              ...
              >
                <div className="flex justify-between items-start mb-3 flex-wrap gap-2">
                  <div>
                    ...
                    {order.customer_comment && (
                      <div className="text-xs text-[#8a92a3] mt-2 italic">
                        💬 {order.customer_comment}
                      </div>
                    )}
                  </div>
                  <div className={`px-3 py-1 rounded-full text-xs font-bold ${statusColors[order.status] || 'bg-gray-500/20 text-gray-400'}`}>
                ...
                <div className="flex justify-between items-center pt-3 mt-3 border-t border-white/10">
                  <div className="text-lg font-black text-white">
                    Итого: <span className="text-[#ff9b26]">{order.total_amount} ₽</span>
                  </div>
